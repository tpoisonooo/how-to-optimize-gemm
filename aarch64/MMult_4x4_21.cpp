  ...
  for (i = 0; i < m; i += 8) {
    for (j = 0; j < n; j += 12) {
      ...
      asm volatile(
        ...
        "ldr    q26,      [%1],     #16       \n"
        "fmla   v3.4s,    v24.4s,   v29.s[1]  \n"
        "fmla   v6.4s,    v24.4s,   v29.s[2]  \n"
        "fmla   v9.4s,    v24.4s,   v29.s[3]  \n"
        "ldr    q27,      [%0],     #16       \n"

        "fmla   v12.4s,   v24.4s,   v30.s[0]  \n"
        "ldr    q28,      [%0],     #16       \n"
        "fmla   v15.4s,   v24.4s,   v30.s[1]  \n"
        "fmla   v18.4s,   v24.4s,   v30.s[2]  \n"
        "fmla   v21.4s,   v24.4s,   v30.s[3]  \n"

        // b1 a0,a1
        "fmla   v1.4s,    v25.4s,   v29.s[0]  \n"
        "ldr    q24,      [%1],     #16       \n"
        "fmla   v4.4s,    v25.4s,   v29.s[1]  \n"
        "fmla   v7.4s,    v25.4s,   v29.s[2]  \n"
        "fmla   v10.4s,   v25.4s,   v29.s[3]  \n"
        "fmla   v13.4s,   v25.4s,   v30.s[0]  \n"
        "fmla   v16.4s,   v25.4s,   v30.s[1]  \n"
        "fmla   v19.4s,   v25.4s,   v30.s[2]  \n"
        "fmla   v22.4s,   v25.4s,   v30.s[3]  \n"

        // b2 a0,a1
        "fmla   v2.4s,    v26.4s,   v29.s[0]  \n"
        "ldr    q25,      [%1],     #16       \n"
        "fmla   v5.4s,    v26.4s,   v29.s[1]  \n"
        "fmla   v8.4s,    v26.4s,   v29.s[2]  \n"
        "fmla   v11.4s,   v26.4s,   v29.s[3]  \n"
        "fmla   v14.4s,   v26.4s,   v30.s[0]  \n"
        "fmla   v17.4s,   v26.4s,   v30.s[1]  \n"
        "fmla   v20.4s,   v26.4s,   v30.s[2]  \n"
        "fmla   v23.4s,   v26.4s,   v30.s[3]  \n"
        "subs   x8,   x8,   #1                \n"
        "bne    run                           \n"
